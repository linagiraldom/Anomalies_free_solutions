...
parser.add_argument("n", help="Valor de n para el cual se \
                    van a calcular las soluciones",
                    type=int)
parser.add_argument("--zmax", help="Valor absoluto del entero \
                    más grande que puede contener las soluciones",
                    type=int)
parser.add_argument("--m", help="Entero máximo que contendrán l y k",
                    type=int)
parser.add_argument("--output_name", "-on", help="Guardar soluciones \
                    en un archivo json con nombre el nombre dado por \
                    el usuario")

parser.add_argument("--cores", "-c", help="Cuántos núcleos desea usar \
